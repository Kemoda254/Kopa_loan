...
//
//        Tapdaq.getInstance().initialize(applyloans5.this, getResources().getString(R.string.applicationid), getResources().getString(R.string.appkey), config, new TapdaqInitListener());
//        Tapdaq.getInstance().setUserSubjectToGDPR(applyloans5.this, STATUS.TRUE);
//        Tapdaq.getInstance().setConsentGiven(applyloans5.this, STATUS.FALSE);
//        Tapdaq.getInstance().setIsAgeRestrictedUser(applyloans5.this, STATUS.UNKNOWN);
...
//        if (Tapdaq.getInstance().isVideoReady(applyloans5.this,"default")) {
//            Tapdaq.getInstance().showVideo(applyloans5.this, "default", new InterstitialListener());
//        }
...
//                }
    ...
    public void back(View arg0) {
        startActivity(new Intent(this, com.shwa.kopes.applyloans4.class));
    }
    public class TapdaqInitListener extends TMInitListener {
        ...
        public void didInitialise() {
            ...
            Tapdaq.getInstance().loadVideo(applyloans5.this,  "default",new InterstitialListener());
