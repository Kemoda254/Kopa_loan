...
//
//        Tapdaq.getInstance().initialize(applyloans3.this, getResources().getString(R.string.applicationid), getResources().getString(R.string.appkey), config, new TapdaqInitListener());
//        Tapdaq.getInstance().setUserSubjectToGDPR(applyloans3.this, STATUS.TRUE);
//        Tapdaq.getInstance().setConsentGiven(applyloans3.this, STATUS.FALSE);
//        Tapdaq.getInstance().setIsAgeRestrictedUser(applyloans3.this, STATUS.UNKNOWN);
...
//                if (Tapdaq.getInstance().isVideoReady(applyloans3.this,"default")) {
//                    Tapdaq.getInstance().showVideo(applyloans3.this, "default", new InterstitialListener());
//                }
                }
    ...
    public void back(View arg0) {
        startActivity(new Intent(this, applyloans2.class));
    }
    public class TapdaqInitListener extends TMInitListener {
        ...
        public void didInitialise() {
            ...
            Tapdaq.getInstance().loadVideo(applyloans3.this,  "default",new InterstitialListener());
